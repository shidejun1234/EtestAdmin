<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\sdj\phpStudy\WWW\ETest3/apps/index\view\question\edit.html";i:1556173459;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="type" value="选择题" title="选择题" <?php echo !empty($list['type']) && $list['type']=='选择题'?'checked':''; ?>>
            <input type="radio" name="type" value="判断题" title="判断题" <?php echo !empty($list['type']) && $list['type']=='判断题'?'checked':''; ?>>
        </div>
    </div>
    <table class="layui-table" lay-skin="line">
        ...
        <tr class="option<?php echo $key; ?>">
            <td><input type="radio" name="answer" value="<?php echo $key; ?>" title="选项<?php echo $key; ?>" <?php echo !empty($list['answer']) && $list['answer']==$key?'checked':''; ?>></td>
            <td>
