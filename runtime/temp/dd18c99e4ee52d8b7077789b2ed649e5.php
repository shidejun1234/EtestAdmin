<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\sdj\phpStudy\WWW\ETest3/apps/index\view\test\add.html";i:1556162305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <tr>
            <td colspan="4">
                <div class="layui-form-item" style="margin-left: 30%;">
                    <div class="layui-input-block">
                        <input type="button" class="layui-btn" id="add_option" value="添加选项">
                    </div>
                </div>
            </td>
        </tr>
    ...
    layui.use('form', function () {
        ...
        $('#add_option').on('click', function () {
            ...
            $('.option' + String.fromCharCode(oIndex - 1)).after('\n' +
                ...
                '            <td><input type="radio" name="answer" value="' + String.fromCharCode(oIndex) + '"></td>\n' +
                '            <td>选项' + String.fromCharCode(oIndex) + '</td>\n' +
                '            <td>\n' +
