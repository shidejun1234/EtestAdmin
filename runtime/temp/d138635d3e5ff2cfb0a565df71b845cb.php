<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\sdj\phpStudy\WWW\ETest3/apps/index\view\question\add.html";i:1557471956;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="subject" lay-verify="required" lay-search="">
                    ...
                    <option value="<?php echo $item['id']; ?>" <?php echo !empty($item['id']) && $item['id']==\think\Request::instance()->session('subject')?'selected':''; ?>><?php echo $item['name']; ?></option>
