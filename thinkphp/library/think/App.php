...
class App
{
    ...
    public static function run(Request $request = null)
    {
        ...
        try {
            ...
            // 记录路由和请求信息
            if (self::$debug) {
                Log::record('[ ROUTE ] ' . var_export($dispatch, true), 'InfoConfig');
                Log::record('[ HEADER ] ' . var_export($request->header(), true), 'InfoConfig');
                Log::record('[ PARAM ] ' . var_export($request->param(), true), 'InfoConfig');
            }
    ...
    public static function invokeFunction($function, $vars = [])
    {
        ...
        // 记录执行信息
        self::$debug && Log::record('[ RUN ] ' . $reflect->__toString(), 'InfoConfig');
